...
# https://docs.djangoproject.com/en/4.1/topics/db/queries/#s-retrieving-objects
#     return render(request, "all_rooms.html", context={"page": page, "page_count": ceil(page_count), "page_range":range(1, page_count)})


# def all_rooms(request):
#   page = request.GET.get("page",1)
#   room_list = models.Room.objects.all()
# query_set 은 이후에 room_list 가 불릴때 db에 접근해 값을 가져올 것이다
#   paginator = Paginator(room_list, 10, orphans=5)
#   try:
#       rooms = paginator.page(int(page))
#       return render(request, "rooms/home.html", {"page":room_list})
#   except EmptyPage:
#       return redirect("/")

class HomeView(ListView):
    # 사용할 template의 이름은 app이름_list.html이 된다.
    """HomeView Definition"""
